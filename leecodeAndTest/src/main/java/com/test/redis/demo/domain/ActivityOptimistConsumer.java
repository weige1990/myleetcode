...
//乐观锁
public class ActivityOptimistConsumer implements Runnable{
    ...
    public ActivityOptimistConsumer(Long productId, String customerId, Long activitId, LocalDateTime resultUpdateTime, RedisTemplate redisTemplate, Long expireTime) {
